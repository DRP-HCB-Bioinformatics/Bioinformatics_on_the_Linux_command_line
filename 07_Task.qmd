...
In this section we are going to use common Unix tools to reformat a text file containing genomic annotations (`GRCm39_ensembl_v110.txt`).
...
``` bash
## Move to the annotation task folder
cd ~/Intro_to_Linux/annotation_task
